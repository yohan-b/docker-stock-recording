...
db = SQLAlchemy(app)
api = Api(app, version='1.0', title='Stock recording',
    description='API to record and access stock market values.', authorizations=authorizations)

ns = api.namespace('/', description='Stock API')
